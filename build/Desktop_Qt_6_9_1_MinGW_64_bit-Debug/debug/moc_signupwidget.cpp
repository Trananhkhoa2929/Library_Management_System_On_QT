...
template <> constexpr inline auto SignUp::qt_create_metaobjectdata<qt_meta_tag_ZN6SignUpE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'error'
        QtMocHelpers::SlotData<void(string)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 2 },
        }}),
        // Slot 'buttonBack'
...
void SignUp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SignUp::*)(string , string , string , int )>(_a, &SignUp::signUpData, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SignUp::*)(int )>(_a, &SignUp::setCurrentWidget, 1))
            return;
    }
}
